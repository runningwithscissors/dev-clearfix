...
(function( factory ) {
	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		_mouseDrag: function(event) {
			...
			if (o.listClass) {
				newList.classList.add(o.listClass);
			}
			...
			for (i = this.items.length - 1; i >= 0; i--) {
				...
				// BoldMinded - If the parent does not allow nesting, then stop looking for a drop spot
				// Unsure why this wasn't checked sooner (shrug)
				if (
					itemElement.parentElement.className.indexOf(o.disableNestingClass) !== -1
				) {
					continue;
				}
